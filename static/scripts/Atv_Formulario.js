...
senha.addEventListener("input", () => {
    if (senha.value && checkPasswordStrength(email.value)) {
...
function checkPasswordMatch() {
    return senha.value === confirmasenha.value ? true : false;
}

// FUNÇÃO PARA INSERIR MASCARA DE TELEFONE
